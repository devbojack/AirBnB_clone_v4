$(document).ready(function () {
  ...
  const $toggleReviewsSpan = $('span.toggle-reviews');
  ...
  $toggleReviewsSpan.click(function () {
    if ($toggleReviewsSpan.text() === 'hide') {
    
      $reviewsDiv.empty();
      $toggleReviewsSpan.text('show');
    } else {
     
      fetchReviews(); 
      $toggleReviewsSpan.text('hide');
    }
  });
